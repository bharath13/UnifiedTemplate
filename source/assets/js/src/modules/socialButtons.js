...
var socialButtons = function () {
    ...
    var pin_brand_url = 'http://www.pinterest.com/cookinglight/';
    var fb_brand_url = 'https://www.facebook.com/CookingLight';
    var email_brand_url = 'http://www.cookinglight.com/general/contact-us';
    var tw_brand_url = 'https://twitter.com/Cooking_Light';
    ...
    $('.social-share__item--twitter').each(function(index){
        ...
        if($(this).parent('.brand-social').length > 0) {
          ...
          $(this).attr('target', '_blank');  
            ...
            var twitter_text = 'text=' + encodeURIComponent(og_description);
    ...
    $('.social-share__item--email').each(function(index){
        ...
        if($(this).parent('.brand-social').length > 0) {
          ...
          $(this).attr('target', '_blank');  
            ...
            var email_body = "I think you'll like this article from CookingLight.com";
            email_body += "\n\n";
            email_body += og_title + "\n";
            email_body += og_url + "\n\n";
            email_body += "Follow Cooking Light on Facebook, Twitter, YouTube, and Pinterest.\n\n";
            email_body += "Follow CookingLight:\n";
            email_body += "Facebook: http://www.facebook.com/CookingLight\n";
            email_body += "Pinterest: http://www.pinterest.com/cookinglight/\n";
            email_body += "Twitter: https://twitter.com/Cooking_Light\n";
            email_body += "YouTube: https://www.youtube.com/user/cookinglight\n";
    ...
    $('.social-share__item--sms').each(function(index){
        var t = this;
        var sms_body = "I think you'll like this link from CookingLight.com";
        sms_body += "\n\n";
        sms_body += og_title + "\n";
        sms_body += og_url + "\n\n";
